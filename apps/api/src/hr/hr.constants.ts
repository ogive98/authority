export const HR_ERROR_CODES = {
  ...
  TRANSFER_NOT_FOUND: 'HR.TRANSFER_NOT_FOUND',
  TRANSFER_EXISTS: 'HR.TRANSFER_EXISTS',
  TRANSFER_INVALID_STATUS: 'HR.TRANSFER_INVALID_STATUS',
  TRANSFER_BANK_REQUIRED: 'HR.TRANSFER_BANK_REQUIRED',
  TRANSFER_COMPANY_BANK_INVALID: 'HR.TRANSFER_COMPANY_BANK_INVALID',
  TRANSFER_AMOUNT_INVALID: 'HR.TRANSFER_AMOUNT_INVALID',
  TRANSFER_PDF_UNAVAILABLE: 'HR.TRANSFER_PDF_UNAVAILABLE',
  TRANSFER_SEPA_STATUS: 'HR.TRANSFER_SEPA_STATUS',
  TRANSFER_SEPA_DEBTOR_RIB: 'HR.TRANSFER_SEPA_DEBTOR_RIB',
  PHOTO_INVALID: 'HR.PHOTO_INVALID',
  USER_INVALID: 'HR.USER_INVALID',
  USER_ALREADY_LINKED: 'HR.USER_ALREADY_LINKED',
  EMAIL_REQUIRED: 'HR.EMAIL_REQUIRED',
  EMAIL_EXISTS: 'HR.EMAIL_EXISTS',
...
export const HR_EVENT_TYPES = {
  ...
  TRANSFER_CREATED: 'hr.transfer.created.v1',
  TRANSFER_CONFIRMED: 'hr.transfer.confirmed.v1',
  TRANSFER_CANCELLED: 'hr.transfer.cancelled.v1',
  TRANSFER_PDF_GENERATED: 'hr.transfer.pdf_generated.v1',
  TRANSFER_SEPA_EXPORTED: 'hr.transfer.sepa_exported.v1',
