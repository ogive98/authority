export const DELIVERY_ERROR_CODES = {
  ...
  ORDER_FULLY_DELIVERED: 'DLV.ORDER_FULLY_DELIVERED',
  ...
  STOCK_RESERVE_FAILED: 'DLV.STOCK_RESERVE_FAILED',
  ROUND_NOT_FOUND: 'DLV.ROUND_NOT_FOUND',
  INVALID_QTY: 'DLV.INVALID_QTY',
  EMPTY_DELIVERY: 'DLV.EMPTY_DELIVERY',
} as const;
