...
export const THUNDER_ERROR_CODES = {
  ...
  RULE_INVALID_ACTION: 'THUNDER.RULE.INVALID_ACTION',
  RULE_CYCLE_DETECTED: 'THUNDER.RULE.CYCLE_DETECTED',
  RULE_EVAL_TIMEOUT: 'THUNDER.RULE.EVAL_TIMEOUT',
  RULE_INVALID_LOGIC: 'THUNDER.RULE.INVALID_LOGIC',
  RULE_NOT_FOUND: 'THUNDER.RULE.NOT_FOUND',
  PAYLOAD_TOO_LARGE: 'THUNDER.PAYLOAD_TOO_LARGE',
  LAYOUT_INVALID: 'THUNDER.LAYOUT_INVALID',
  SIGNAL_NOT_FOUND: 'THUNDER.SIGNAL_NOT_FOUND',
  RECO_NOT_FOUND: 'THUNDER.RECO_NOT_FOUND',
  RECO_INVALID_STATE: 'THUNDER.RECO_INVALID_STATE',
  COMPANY_REQUIRED: 'THUNDER.COMPANY_REQUIRED',
  ENTITLEMENT_DENIED: 'THUNDER.ENTITLEMENT_DENIED',
} as const;
