    ...
    features: [
      {
        ...
        steps: {
          fr: [
            ...
            "POSTED → « Décaisser » : RAS déduit auto si Prefs VALIDATED (net = base − RAS) ; toggle pour exception.",
      ...
      },
      {
        ...
        steps: {
          fr: [
            ...
            "À l’émission : snapshot fiscal `tax_line` figé (taux ultérieurs ne recalculent pas la facture).",
          ...
          it: [
            ...
            "All’emissione: snapshot fiscale `tax_line` congelato (tassi successivi non ricalcolano la fattura).",
    ...
    features: [
      {
        ...
        steps: {
          fr: [
            ...
            "RAS = retenue à la source (rateBps) ; TEJ = params locaux — brouillon XML sur `/tax` (D265), jamais transmission.",
          ...
          it: [
            ...
            "RAS = ritenuta alla fonte (rateBps); TEJ = params locali — bozza XML su `/tax` (D265), mai trasmissione.",
