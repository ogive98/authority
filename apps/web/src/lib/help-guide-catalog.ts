  ...
  },
  {
    ...
    features: [
      {
        ...
        steps: {
          fr: [
            ...
            "Fournisseur = texte libre (D205) — pas de master obligatoire, pas de TVA inventée.",
            "Bandeau Expertise RAS/TEJ : consumers seulement si Prefs VALIDATED (D246).",
            "Sur la fiche : Poster (DRAFT → POSTED) → écriture GL Dr Achats / Cr Fournisseurs via Thunder (D273) si Accounting on.",
            "POSTED → « Décaisser » : RAS déduit auto si Prefs VALIDATED ; paiement → Dr AP / Cr Banque (net).",
            "Annuler une facture POSTÉE contrepasse le GL AP si écriture existante.",
            "Mapping comptes : `/accounting?tab=mapping` (401 / 601 / ACH).",
          ],
          it: [
            "Apri `/finance/ap-bills` → « + Nuova fattura fornitore ».",
            "Chip Tutti / Bozza / Registrata / Annullata — URL `?status=` condividibile.",
            "Fornitore = testo libero (D205) — anagrafica non obbligatoria, niente IVA inventata.",
            "Fascia Expertise RAS/TEJ: consumer solo se Prefs VALIDATED (D246).",
            "In scheda: Registra (DRAFT → POSTED) → scrittura GL Dr Acquisti / Cr Fornitori via Thunder (D273) se Accounting on.",
            "POSTED → « Pagare »: RAS detratto auto se Prefs VALIDATED; pagamento → Dr AP / Cr Banca (netto).",
            "Annullare una fattura POSTED storna il GL AP se scrittura esistente.",
            "Mapping conti: `/accounting?tab=mapping` (401 / 601 / ACH).",
          ],
        },
      },
      {
    ...
    locks: {
      fr: [
        ...
        "RAS auto déduit sur décaissement AP si Prefs VALIDATED (D264) · toggle exception · pas de TEJ transmission.",
      ...
      it: [
        ...
        "RAS auto detratto su pagamento AP se Prefs VALIDATED (D264) · toggle eccezione · niente TEJ transmission.",
    ...
    features: [
      {
        ...
        steps: {
          fr: [
            ...
            "Mapping GL : AR + AP (Fournisseurs/Achats/journal ACH) — Prefs société.",
            "AP bill POSTÉ / décaissement → écriture GL via Thunder si module Accounting on (D273).",
          ...
          it: [
            ...
            "Mapping GL: AR + AP (Fornitori/Acquisti/giornale ACH) — Prefs azienda.",
            "AP bill POSTED / pagamento → scrittura GL via Thunder se Accounting on (D273).",
