...
export const USAGE_TIPS: UsageTip[] = [
  ...
  },
  {
    ...
    routes: ["/", "/settings"],
    modules: ["home", "settings"],
    title: "Thème clair / sombre D294",
    body: "L’icône lune / soleil bascule canvas D294 (#f5f6f8 ↔ #14161a). Surfaces opaques — le logo Covelli reste lisible sur les deux thèmes.",
    category: "a11y",
  ...
  },
  {
    ...
    body: "Vérifiez le client et le site avant envoi — remises % 0–100 · idempotency sur confirm.",
    category: "stock",
  ...
  },
  {
    ...
    modules: ["sales"],
    title: "Devis",
    body: "Sans réserve stock — Envoyer puis Convertir → commande brouillon (pas d’auto-confirm).",
    category: "stock",
    action: { kind: "link", href: "/sales/quotes", label: "Devis" },
  },
  {
    id: "returns-rma",
    routes: ["/sales/returns"],
    modules: ["sales"],
    title: "Retours",
    body: "Sous-module Ventes — livraison DELIVERED · Poster restock/rebut · avoir DRAFT.",
    category: "stock",
    action: { kind: "link", href: "/sales/returns", label: "Retours" },
  },
  {
    id: "sales-customers",
    routes: ["/customers"],
  ...
  // —— Extended pack (rotation / densité) ——
  {
    ...
    modules: ["home"],
    title: "Logo société",
    body: "Le bandeau topbar affiche le logo Fattorie Covelli (PNG) + Powered by AUTHORITY® · Haithem Hammami.",
    category: "navigation",
  ...
  },
  {
    ...
    routes: ["/"],
    modules: ["home"],
    title: "Canvas D294 opaque",
    body: "Le canvas D294 est opaque (surface-1 / surface-2) — un accent, pas de blur Soft Glass sur les pages.",
    category: "a11y",
  ...
  },
  {
    ...
    body: 'Le logo Fattorie Covelli (PNG transparent) reste dans la barre horizontale : adapté clair/sombre. À droite : Powered by AUTHORITY® · Haithem Hammami. Réduire la sidebar ne déplace jamais ce bandeau.',
    category: 'navigation',
    action: { kind: 'link', href: '/help#brand', label: 'Identité' },
  },
  {
