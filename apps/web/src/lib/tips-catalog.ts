...
export const USAGE_TIPS: UsageTip[] = [
  ...
  },
  {
    ...
    routes: ["/"],
    modules: ["home"],
    title: "Un clic module = Launchpad métier",
    body: "La sidebar liste seulement les modules (icône outline + nom). Un clic sélectionne le module et affiche ses fonctionnalités en grande grille centrée sur l’accueil — comme un Launchpad. Pas de sous-menus encadrés ni de toggles.",
    category: "navigation",
  ...
  },
  {
    ...
    modules: ['home'],
    title: 'Un clic module = Launchpad métier',
    body: 'La sidebar liste seulement les modules (icône outline + nom). Un clic sélectionne le module et affiche ses fonctionnalités en grille centrée sur l’accueil. Il n’y a plus de toggle : la navigation est directe, comme un Finder + Launchpad.',
    category: 'navigation',
