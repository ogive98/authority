...
export const USAGE_TIPS: UsageTip[] = [
  ...
  // —— Extended pack (rotation / densité) ——
  {
    ...
    modules: ["home"],
    title: "Logo société",
    body: "Le bandeau topbar affiche le logo Fattorie Covelli (PNG) + Powered by AUTHORITY · Haithem Hammami R.",
    category: "navigation",
  ...
  },
  {
    ...
    body: 'Le logo Fattorie Covelli (PNG transparent) reste dans la barre horizontale : adapté clair/sombre. À droite : Powered by AUTHORITY · Haithem Hammami R. Réduire la sidebar ne déplace jamais ce bandeau.',
    category: 'navigation',
    action: { kind: 'link', href: '/help#brand', label: 'Identité' },
  },
  {
