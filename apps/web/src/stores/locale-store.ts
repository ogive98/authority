...
const SHELL_I18N = {
  fr: {
    ...
    langToggle: "Langue — basculer français / italiano (icône globe)",
    ...
    operationalOverview: "Vue opérationnelle · Aujourd’hui",
    ...
    thunderCoreOpen: "Thunder Core — Command Center",
    thunderCoreHint: "Ouvre le tableau de bord monitoring complet.",
    ...
    kpiBackupTotal: "Sauvegardes",
    kpiBackupRestorable: "Restaurables",
    kpiBackupOpenRestores: "Restores ouverts",
    kpiBackupFailed: "Échouées",
    widgetShellStatus: "État plateforme",
    widgetTasks: "Tâches",
    widgetShortcuts: "Raccourcis module",
    widgetActivity: "Activité",
    widgetAi: "Assistant IA",
    widgetTreasury: "Trésorerie bancaire",
    widgetBackup: "Sauvegarde",
    backupLastLabel: "Dernière ·",
    backupOpenRestores: "Restores ouverts",
    backupAutoSchedule: "Auto Tunis",
    backupOpenModule: "Ouvrir Sauvegardes",
    treasuryAccounts: "Comptes",
    treasuryUnmatched: "Non rapprochées",
    treasuryMatched: "Rapprochées",
    treasuryIgnored: "Ignorées",
    treasuryGlBalance: "Solde GL banque",
    treasuryGlHidden: "Solde GL masqué",
    treasuryOpenBanking: "Ouvrir Banque",
  },
  it: {
    ...
    langToggle: "Lingua — cambia francese / italiano (icona globo)",
    ...
    missionControl: "Mission Control",
    operationalOverview: "Panoramica operativa · Oggi",
    controlCenter: "Control Center",
    aiDisabled: "DISABLED",
    ...
    thunderCore: "Thunder Core",
    thunderCoreOpen: "Thunder Core — Command Center",
    thunderCoreHint: "Apre la dashboard di monitoring completa.",
    ...
    kpiBackupTotal: "Backup",
    kpiBackupRestorable: "Ripristinabili",
    kpiBackupOpenRestores: "Restore aperti",
    kpiBackupFailed: "Falliti",
    ...
    widgetTreasury: "Tesoreria bancaria",
    widgetBackup: "Backup",
    backupLastLabel: "Ultimo ·",
    backupOpenRestores: "Restore aperti",
    backupAutoSchedule: "Auto Tunis",
    backupOpenModule: "Apri Backup",
    treasuryAccounts: "Conti",
    treasuryUnmatched: "Non riconciliate",
    treasuryMatched: "Riconciliate",
    treasuryIgnored: "Ignorate",
    treasuryGlBalance: "Saldo GL banca",
    treasuryGlHidden: "Saldo GL nascosto",
    treasuryOpenBanking: "Apri Banca",
  },
} as const;
