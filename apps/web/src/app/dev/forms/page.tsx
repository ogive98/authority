...
export default function DevFormsPage() {
  ...
  return (
    <div className="min-h-screen bg-a-surface-1 text-a-fg">
      <header className="flex items-center justify-between gap-4 border-b border-a-border-subtle px-[var(--a-space-6)] py-[var(--a-space-4)]">
        <div>
          ...
          <p className="mt-1 text-[length:var(--a-text-sm)] text-a-fg-muted">
            Gate : wording stock / argent · Idempotency-Key · drawer fiche
          </p>
        </div>
      ...
      <main className="mx-auto grid max-w-4xl gap-6 px-[var(--a-space-6)] py-[var(--a-space-7)] lg:grid-cols-2">
      ...
      <ADrawer
        ...
        footer={
          <div className="flex justify-end gap-2">
            ...
            <AButton type="button" size="sm" onClick={() => setDrawerOpen(false)}>
              OK
            </AButton>
          </div>
        }
