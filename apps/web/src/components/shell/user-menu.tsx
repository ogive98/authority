    ...
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          ...
          className="a-glass-strong absolute right-0 top-[calc(100%+0.35rem)] z-[var(--a-z-dropdown)] w-56 overflow-hidden rounded-[var(--a-radius-md)] shadow-[var(--a-shadow-panel)]"
        >
